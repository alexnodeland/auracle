...
//! cargo run -p ricercar-session --example learn_synthetic --release -- --compare
//! #                                                 ~19 CPU-minutes, fanned
//! #                                                 out one thread per run)
//!
//! # more seeds if you want tighter error bars     (scales linearly)
//! cargo run -p ricercar-session --example learn_synthetic --release -- --compare 20
//! ```
//!
...
//!
//! [`Acquisition`]: ricercar_session::Acquisition
//!
...
use ricercar_session::{Acquisition, Engine, SessionConfig};
use ricercar_taste::synthetic::cosine;
use ricercar_taste::{Standardizer, SyntheticUser};
