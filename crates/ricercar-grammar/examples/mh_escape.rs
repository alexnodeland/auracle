...
//!
//! ```bash
//! cargo run -p ricercar-grammar --example mh_escape --release
//! cargo run -p ricercar-grammar --example mh_escape --release -- 100000  # steps per chain
//! ```
//!
...
use ricercar_grammar::{in_domain, PatchGrammarPrior, PatchTree};
