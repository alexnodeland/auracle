...
[How to read this](./introduction.md)
[Notation](./notation.md)

# Architecture

- [The crates](./architecture/crates.md)
- [The two loops](./architecture/two-loops.md)
- [Trace addresses](./architecture/addresses.md)

# The genome

- [A typed PCFG over patch terms](./genome/grammar.md)
- [Parameter sites and their domains](./genome/parameters.md)
- [Structural edits](./genome/edits.md)
- [Compilation to a patch](./genome/compilation.md)
...
- [Utility as a max of experts](./taste/utility.md)
- [One utility, three likelihoods](./taste/likelihoods.md)
- [The posterior](./taste/posterior.md)
- [Calibration](./taste/calibration.md)
